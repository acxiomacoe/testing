...
###############################################################################################
  ...
  measure: spending_target_sum {
    type: number
    sql:SUM(CASE WHEN ${target_flg} = {% parameter ib_hybrid_phu_test1.target_select %} THEN ${ibe_spending_value} ELSE 0 END);;
  }
  ...
  measure: spending_reference_sum {
    type: number
    sql:SUM(CASE WHEN ${target_flg} = {% parameter ib_hybrid_phu_test1.refrence_select %} THEN ${ibe_spending_value} ELSE 0 END);;
  }
